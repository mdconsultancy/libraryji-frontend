...
const blocks: LegalBlock[] = [
  ...
  {
    type: "p",
    text: "LibraryJi is a subscription-based (SaaS) library and study room management software. It helps libraries, reading rooms, study rooms, and coaching/self-study centres run their day-to-day operations online instead of on paper registers and spreadsheets. Customers pay a recurring subscription fee to access the LibraryJi web panel and mobile apps and the features included in their chosen plan.",
  },
  { type: "p", text: "Features may include:" },
  {
    type: "ul",
    items: [
      "Seat and shift/rotation management with live seat availability",
      "Student and member enrollment and profiles",
      "Membership plans and subscription (fee) durations",
      "Fee and payment collection, dues and partial-payment tracking",
      "Daily attendance check-in and check-out records",
      "Membership renewals and expiry tracking",
      "Reports, dashboard and analytics (revenue, attendance, occupancy, expiring memberships)",
      "PDF and Excel exports of records and reports",
      "Staff/user accounts with role-based permissions",
      "Account and billing (plan) management",
      "Other features introduced by LibraryJi from time to time",
    ],
  },
  { type: "p", text: "Available features and usage limits vary depending on the subscription plan selected." },
  ...
  { type: "p", text: "This may include:" },
  {
    ...
    items: [
      ...
      "Seat and shift assignments",
      "Membership plan and subscription details",
      "Attendance records",
      "Fee, payment and expense information",
      "Staff information",
      "Notes",
      "Reports",
      "Other library or study room operational data",
    ],
  },
  {
    type: "p",
