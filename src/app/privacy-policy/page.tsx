...
const blocks: LegalBlock[] = [
  {
    type: "p",
    text: 'Welcome to LibraryJi ("LibraryJi", "we", "us", or "our"). LibraryJi is a subscription-based (SaaS) library and study room management software that enables libraries, reading rooms, study rooms, and self-study/coaching centres to manage their students and members, seats and shifts, attendance, membership plans, fee collection, subscriptions, reports, and other day-to-day operations through our website, mobile applications, and related services.',
  },
  ...
  },
  {
    ...
    items: [
      "Student/member name",
      "Contact details",
      "Student/member ID or code",
      "Photo and ID-proof details (where uploaded by the library)",
      "Enrollment and membership information",
      "Seat and shift assignment",
      "Attendance records",
      "Membership plan, subscription period and renewal information",
      "Fee, payment, due and transaction history",
  ...
  { type: "p", text: "We may use information to:" },
  {
    ...
    items: [
      ...
      "Provide library and study room management functionality",
      "Manage students, members, seats, shifts and attendance",
      "Manage membership plans, fees, dues and renewals",
